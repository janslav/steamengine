...
namespace SteamEngine.LScript {
	public class OpNode_ConstructArray_Length : OpNode, IOpNodeHolder, ITriable {
		private Type type;
	...
	public class OpNode_ConstructArray_LengthConstant : OpNode, ITriable {
		private Type type;
		private int length;
	...
	public class OpNode_ConstructArray_Elements : OpNode, IOpNodeHolder, ITriable {
		private Type type;
