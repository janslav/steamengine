...
//                        c.WriteLine("Unknown packet 0x" + packet[0].ToString("x"));
//                        OutputPacketLog();
//                        packetLenUsed = packetLen;
//                        return;
//                    }
...
//                                    }
//                                default: {
//                                        c.WriteLine("Unknown party command " + subcmd2.ToString("x") + " in HandleSubCommandPacket.");
//                                        return false;
//                                    }
//                            }
...
//                        }
//                    default: {
//                            c.WriteLine("Unknown subcommand " + subcmd.ToString("x") + " in HandleSubCommandPacket.");
//                            return false;
//                        }
//                }
