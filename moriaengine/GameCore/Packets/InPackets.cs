...
//                } else {
//                    c.WriteLine("Your account is not priviliged enough to use god-mode.");
...
//        //        Packets.Prepared.SendFailedLogin(c, LoginDeniedReason.CommunicationsProblem);
...
//        //        Packets.Prepared.SendRejectDeleteRequest(c, DeleteCharacterResult.Deny_NonexistantCharacter);
//        //        return;
//        //    }
//        //    AbstractAccount acc = c.curAccount;
//        //    DeleteCharacterResult drr = acc.RequestDeleteCharacter(charIndex);
//        //    if (drr==DeleteCharacterResult.Allow) {
//        //        PacketSender.SendCharacterListAfterDelete(c);
//        //    } else if (drr!=DeleteCharacterResult.Deny_NoMessage) {
