...
//                ISkill curSkill = ((AbstractCharacter) thing).GetSkillObject(id);
//                if(curSkill != null) {
//                    PacketSender.PrepareSingleSkillUpdate(curSkill, displaySkillCaps);
//                    PacketSender.SendTo(conn, true);
//                } else {
//                    //send info about nulled skill (0 values)
//                    PacketSender.PrepareSingleSkillNulled(id, displaySkillCaps);
//                    PacketSender.SendTo(conn, true);					
//                }
//            }
//        }
...
//            ItemOnGroundUpdater.RemoveFromCache(thing);
//            if (enabled) {
...
//            if (enabled) {
//                PopAndEnqueueInstance(ch).AboutToChangeVisibility();
//            }
//        }
...
//                weight = c.Weight;
//                stat1 = c.ExtendedStatusNum01;
//                stat2 = c.ExtendedStatusNum02;
//                stat3 = c.ExtendedStatusNum03;
//                stat4 = c.StatusMindDefense;
//                stat5 = c.ExtendedStatusNum04;
//                stat6 = c.ExtendedStatusNum05;
//                stat7 = c.ExtendedStatusNum06;
...
//                (armorClass != c.StatusArmorClass) ||
//                (weight != c.Weight) || (stat1 != c.ExtendedStatusNum01) ||
//                (stat2 != c.ExtendedStatusNum02) || (stat3 != c.ExtendedStatusNum03) ||
//                (stat4 != c.StatusMindDefense) || (stat5 != c.ExtendedStatusNum04) ||
//                (stat6 != c.ExtendedStatusNum05) || (stat7 != c.ExtendedStatusNum06) ||
//                (tithingPoints != c.TithingPoints)));
...
//                            if (item.IsContainer &&
//                                    item.Count > 0 &&
//                                    (OpenedContainers.HasContainerOpen(viewer, item) == DenyResult.Allow)) {
