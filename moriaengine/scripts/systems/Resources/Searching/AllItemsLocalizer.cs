...
namespace SteamEngine.CompiledScripts {
	...
	public class AllItemsLocalizer : ItemsLocalizer {
		private static AllItemsLocalizer instance;

		private AllItemsLocalizer() {
		...
		internal static AllItemsLocalizer GetInstance {
			get {
				if (instance == null) {
					instance = new AllItemsLocalizer();
				}
				return instance;
			}
		}
