...
namespace SteamEngine.CompiledScripts {
	[Summary("Class for finding items in characters backpack")]
	public class BackpackItemsLocalizer : ItemsLocalizer {
		private static BackpackItemsLocalizer instance;

		private BackpackItemsLocalizer() {
		...
		internal static BackpackItemsLocalizer GetInstance {
			get {
				if (instance == null) {
					instance = new BackpackItemsLocalizer();
				}
				return instance;
			}
		}
